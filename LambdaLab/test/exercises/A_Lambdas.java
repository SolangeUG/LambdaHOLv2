...
public class A_Lambdas {
    ...
    public void b_function1() {
        Function<String, String> func = string -> "(".concat(string).concat(")");
    ...
    public void c_consumer1() {
        Consumer<StringBuilder> cons = strBuilder -> strBuilder.append("abc");
    ...
    public void e_bifunction1() {
        BiFunction<String, String, String> bifunc = (first, second) -> first.concat(second).concat(first);
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (first, second) -> first.indexOf(second);
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = string -> "abcdefghij".indexOf(string);
