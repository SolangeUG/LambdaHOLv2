...
public class B_Comparators {
    ...
    public void comparator05() {
        Comparator<Person> reversedFirstName = Comparator.comparing(Person::getFirstName).reversed();
        Comparator<Person> reversedLastName = Comparator.comparing(Person::getLastName).reversed();
        Comparator<Person> comparebyLastNameThenFirstNameReversed = reversedLastName
                                                                        .thenComparing(reversedFirstName);
    ...
    public void comparator06() {
        Comparator<Person> peopleComparator = Comparator.comparing(Person::getLastName).thenComparing(Person::getFirstName);
        Comparator<Person> comparebyLastNameThenFirstNameWithNull = Comparator.nullsLast(peopleComparator);
    ...
    public void comparator07() {
        ...
        assertEquals(0, comparebyAge.compare(paul, paul));
    ...
    public void comparator08() {
        IntBinaryOperator intCompare = (first, second) -> Integer.compare(first, second);
    ...
    public void comparator09() {
        ...
        assertTrue(intCompare.applyAsInt(0, 1) < 0);
        assertEquals(0, intCompare.applyAsInt(1, 1));
        assertTrue(intCompare.applyAsInt(2, 1) > 0);
        assertTrue(intCompare.applyAsInt(Integer.MIN_VALUE, Integer.MAX_VALUE) < 0);
        assertTrue(intCompare.applyAsInt(Integer.MAX_VALUE, Integer.MIN_VALUE) > 0);
    }
    ...
    public void comparator10() {
        ...
        assertEquals(0, doubleCompare.applyAsInt(1.0, 1.0));
        assertTrue(doubleCompare.applyAsInt(2.0, 1.0) > 0);
        assertEquals(0, doubleCompare.applyAsInt(Double.NaN, Double.NaN));
